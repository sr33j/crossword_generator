...
fn load_dictionary() -> Vec<(String, i32)> {
    fs::read_to_string("/Users/srijithpoduval/Documents/Projects/crossword_generator/src/all_word_scores_no_title.csv")
...
fn main() {
    ...
    let grid = fs::read_to_string("/Users/srijithpoduval/Documents/Projects/crossword_generator/src/cw_config.txt")
        .expect("Something went wrong reading the file");
    let fmt_grid = "\n".to_owned() + &grid + "\n";    
    ...
    fs::write("/Users/srijithpoduval/Documents/Projects/crossword_generator/src/cw_output.txt", display_grid)
